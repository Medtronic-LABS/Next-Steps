...
pkg_dir = os.path.join(deploy_dir, 'next_steps_ec2_deployment')
...
# 4. Android APK
apk_src = os.path.join(deploy_dir, 'NextSteps-MaternalCare.apk')
  ...
  apps: [
    {
      ...
      env: {
        ...
        WHATSAPP_PHONE_NUMBER_ID: '1348632234997870',
        WHATSAPP_ACCESS_TOKEN: 'EAAPgIbdDLigBSkeXGVlZCngawosMrWPMOP5wC14dyZCQKqKPnlZBrK6OSJaTcQWGFlbWfAt8qf9KBWO1wZCVIZB6YrAcwUMps9NZAWDallLKZBRc6ZCHKkormiZC539miSDTWWTpyPUJJWA8nKEIhjIOedLrFPWnwDmZCGjYIJdS321xGxwIjkI2sJVbPREsgZAmwZDZD',
        WHATSAPP_VERIFY_TOKEN: 'nextsteps_verify_token_2026',
        TEST_ANM_PHONE: '+919899114279',
        TEST_PHC_PHONE: '+918377860959',
        TEST_CHC_PHONE: '+919845278064',
        NEXTSTEPS_APP_BASE_URL: 'https://nextsteps-admin.mdtlabs.org',
      },
    },
  ],
};
...
zip_path = os.path.join(deploy_dir, 'next_steps_ec2_deployment.zip')
