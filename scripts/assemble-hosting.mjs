// Combine the built PWAs into one Firebase Hosting directory:
//   hosting/            <- Admin app (served at /)
//   hosting/doctor/     <- Doctor app (served at /doctor/)
//   hosting/maternal/   <- Maternal app (served at /maternal/)
...
for (const dist of ['apps/admin/dist', 'apps/doctor/dist', 'apps/maternal/dist']) {
...
cpSync(p('apps/maternal/dist'), p('hosting/maternal'), { recursive: true });
console.log('Assembled hosting/  (admin at /, doctor at /doctor/, maternal at /maternal/)');
