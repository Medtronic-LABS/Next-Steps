...
export const TABMETA: Record<string, { label: string; hiLabel: string; icon: string }> = {
  home:{label:'Services', hiLabel:'सेवाएं', icon:'M4 7h6l1.6 2H20v10a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1z'},
  insights:{label:'Insights', hiLabel:'इनसाइट्स', icon:'M4 20V10M10 20V4M16 20v-7M22 20H2'},
  lookup:{label:'Lookup', hiLabel:'खोजें', icon:'M11 4a7 7 0 1 0 0 14 7 7 0 0 0 0-14zM20 20l-3.5-3.5'},
  worklist:{label:'Worklist', hiLabel:'वर्कलिस्ट', icon:'M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01'},
  alerts:{label:'Alerts', hiLabel:'अलर्ट', icon:'M12 3a6 6 0 0 0-6 6c0 5-2 6-2 6h16s-2-1-2-6a6 6 0 0 0-6-6zM10 20a2 2 0 0 0 4 0'},
  mcdash:{label:'My progress', hiLabel:'मेरी प्रगति', icon:'M4 20V10M10 20V4M16 20v-7M22 20H2'},
  coach:{label:'Refresher', hiLabel:'रिफ्रेशर', icon:'M12 3l9 4.5-9 4.5L3 7.5zM7 10.5V16c0 1.7 2.2 3 5 3s5-1.3 5-3v-5.5'},
  training:{label:'Training', hiLabel:'प्रशिक्षण', icon:'M4 5.5A2 2 0 0 1 6 4h5v16H6a2 2 0 0 1-2-2zM11 4h7a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-7'},
  library:{label:'My library', hiLabel:'मेरी लाइब्रेरी', icon:'M6 3h9l4 4v14H6zM14 3v5h5M9 13h7M9 17h5'},
  ask:{label:'Ask', hiLabel:'पूछें', icon:'M21 12a8 8 0 0 1-11.6 7.1L4 20l1-4.4A8 8 0 1 1 21 12z'},
};
...
export const I18N = {
  en: {
    ...
    emptyWorklist: 'No pending patients in this register.',
    careJourney: 'Care Journey',
    medicalChart: 'Full Medical Chart',
    switchRole: 'Switch login',
  ...
  hi: {
    ...
    alerts: 'अलर्ट',
    insights: 'इनसाइट्स',
    addStep: '➕ नया स्टेप जोड़ें',
    closeStep: 'स्टेप पूरा करें',
    register: 'नया मरीज़ जोड़ें',
    all: 'सभी',
    overdue: 'समय बीता',
    dueToday: 'आज देय',
    upcoming: 'आने वाले',
    ...
    cancel: 'रद्द करें',
    confirm: 'पुष्टि करें',
    searchPlaceholder: 'नाम, मोबाइल या ID से खोजें...',
    emptyWorklist: 'इस रजिस्टर में कोई पेंडिंग मरीज़ नहीं है।',
    careJourney: 'केयर जर्नी',
    medicalChart: 'मेडिकल रिकॉर्ड',
    switchRole: 'लॉगिन बदलें',
